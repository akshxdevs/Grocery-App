            ...
            {cart.length > 0 ? (
              <div className="py-20 px-4 flex flex-col gap-3 ">
                <div className="border border-slate-300 rounded-lg shadow-lg">
                    <div className="p-2 ">
                        <h1 className="font-semibold">Delivery in 6 min</h1>
                    </div>
                    {cart.map((item, index) => (
                    ...
                    <div className="flex pt-10 ">
                        <div className="flex gap-20 py-2 border border-slate-300">
                            <div className="py-2 text-sm border">
                ...
                <div className="fixed bottom-2 right-9 w-1/5 bg-pink-600 rounded-xl">
                    <div className="text-center p-3   text-slate-100 font-bold">
